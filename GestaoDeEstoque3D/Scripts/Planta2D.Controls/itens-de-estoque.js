...
function CriarControlItensDeEstoque(classeA = 'toolbar-a') {
    var container = L.DomUtil.create('div');
    container.classList.add("button-container");

    var a = L.DomUtil.create('a');
    a.classList.add("leaflet-buttons-control-button", classeA);
    a.innerHTML = '<i class="fas fa-pallet control-icon" title="Itens de Estoque"></i>';
    
    container.append(a);

    container.onclick = function () {
        $('#ModalItensDeEstoque').css('display', 'flex');
