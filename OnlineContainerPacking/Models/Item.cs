...
namespace OnlineContainerPacking.Models
{
	/// <summary>
	...
	public class Item
	{
		...
		public Item(int id, decimal dim1, decimal dim2, decimal dim3, int quantity, int tipoDeItemId = 0)
		{
			this.ID = id;
			this.Dim1 = dim1;
			this.Dim2 = dim2;
			...
			this.TipoDeItemId = tipoDeItemId;
		}

		public Item(int id, decimal dim1, decimal dim2, decimal dim3, decimal packX, decimal packY, decimal packZ, int quantity, int tipoDeItemId = 0, int? itemBaseId = null, double peso = 0, double pesoMaximo = 1)
		{
			this.ID = id;
			this.Dim1 = dim1;
			this.Dim2 = dim2;
		...
		[DataMember]
		public bool EmpilhamentoDisponivel { get; set; } = true;

		[DataMember]
		public List<Item> ItensEmpilhados { get; set; } = new List<Item>();

		[DataMember]
		public int TipoDeItemId { get; set; }
